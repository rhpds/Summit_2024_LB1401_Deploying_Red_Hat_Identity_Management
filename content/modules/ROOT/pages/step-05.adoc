...
all:
  ...
  vars:
# Global variables
    admin_password:  "Redhat123!" # Administrator password used for all applications
    ad_admin_password: "{ssh_password}"
...
## AD Enterprise User/Group Creation
    ...
    ad_admin_password: "{{ ad_admin_password }}" # AD administrator password
